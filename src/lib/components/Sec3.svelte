<script lang="ts">
	import bp2 from '$lib/assets/bp-2.svg';
</script>

<div class="overflow-hidden base-color py-24 sm:py-32">
		...
		>
			<div class="lg:pr-8 lg:pt-4">
				<div class="lg:max-w-lg">
					<h2 class="text-base font-semibold leading-7 text-indigo-400">SUAS 2025</h2>
					<p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
						Flagship project
					</p>
					<p class="mt-6 text-lg leading-8 text-gray-300">
						Our main goal for the upcoming year is to build a drone for the SUAS 2025 competition.
						This competition is the largest aerial robotics competition in the world, and is the first
						of its kind for undergraduate students.
					</p>
			...
			<img
				...
				class="w-[48rem] max-w-none rounded-xl sm:w-[57rem] md:-ml-4 lg:-ml-0"
				width="2432"
				height="1442"
			/>
		</div>

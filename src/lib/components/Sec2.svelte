<div class="base-color py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
			...
			>
				<div>
					<p>
						At UAS@UCLA, we undertake various research projects to advance drone technology and
						provide hands-on experience to our members. Our projects are designed to foster
						innovation, practical applications, and interdisciplinary collaboration, offering a
						dynamic environment where students can explore cutting-edge technology and its
						real-world applications.
					</p>
				</div>
				<div>
					<p>
						Experienced team members will guide you through the research and development process,
						providing support and mentorship as you build your skills. This approach ensures that
						while you engage in complex projects, you receive the necessary guidance to succeed and

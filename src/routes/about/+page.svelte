...
<div class="bg-gray-900 pb-24">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
	  <div class="mx-auto max-w-5xl sm:text-center">
		<h2 class="text-base font-semibold leading-7 text-indigo-400">For Mechanical & Electrical Engineering Majors</h2>
		<p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Solar Plane</p>
		<p class="mt-6 text-lg leading-8 text-gray-300">This project involves research into the development of solar-powered planes, aimed at exploring sustainable aviation solutions. The team will work on optimizing the efficiency of solar energy utilization in flight, including the design and integration of solar panels, energy storage systems, and lightweight structures. Participants will gain hands-on experience in aerodynamics, renewable energy technologies, and environmental impact assessment, contributing to the advancement of green aviation.</p>
	  </div>
	</div>
  ...
  <div class="bg-gray-900 pb-24">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
	  <div class="mx-auto max-w-5xl sm:text-center">
		...
		<p class="mt-6 text-lg leading-8 text-gray-300">Focused primarily on Computer Science majors, this project aims to develop sophisticated software and vision systems for 3D mapping using automated drones. The goal is to create accurate and detailed 3D models of various terrains and environments. Team members will work on algorithms for data collection, processing, and visualization, as well as drone navigation and control. Collaboration with the VECTR lab will provide additional resources and expertise, enhancing the project's scope and capabilities.</p>
	  </div>
	</div>
	<div class="relative overflow-hidden pt-16">
	  <div class="mx-auto max-w-7xl px-6 lg:px-8">
		<img src={bp6} alt="App screenshot" class="rounded-2xl mb-[-12%]" width="2432" height="1442">
		<div class="relative" aria-hidden="true">
		  <div class="absolute -inset-x-20 bottom-0 bg-gradient-to-t from-gray-900 pt-[7%]"></div>
		</div>
	  </div>
  ...
  <div class="bg-gray-900 pb-24">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
	  <div class="mx-auto max-w-5xl sm:text-center">
		...
		<p class="mt-6 text-lg leading-8 text-gray-300">This project explores the innovative use of drones for delivery services. The objective is to design and test systems that ensure efficient and reliable package delivery. Team members will tackle challenges such as navigation in urban environments, payload handling, and delivery accuracy. The project will cover aspects of logistics, flight control, and system integration, offering participants valuable insights into the future of automated delivery systems and the potential for commercial applications.</p>
	  </div>
	</div>
	<div class="relative overflow-hidden pt-16">
	  <div class="mx-auto max-w-7xl px-6 lg:px-8">
